...
fprintf('Enter the cost matrix with rows as cars and columns as customers ( 0 for a sample matrix) \n');
omat=input('');
if(omat==0)
...
for i=2:size(assign,1)
   fprintf('Car%d -> Customer%d , Cost - %d\n',assign(i,1),assign(i,2),omat(assign(i,1),assign(i,2)));
  totalcost=totalcost+omat(assign(i,1),assign(i,2));
end
fprintf ('The total cost for this optimal assignment is %d.\n',totalcost);
